  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="description" content="Join group yoga sessions are designed in a way that students get personalised attention. Build strength, flexibility & community with expert instructors. Online & Delhi in-person. Book your first free class." />
        ...
        <meta property="og:image" content="/img/services/yoga/group-yoga-session.jpg" />
          ...
          <div className="container">
            <div className="row g-5 align-items-center">
              <div className="col-lg-6">
                ...
                <p className=" mb-3">
                  Our group classes are designed to ensure <strong>every student receives individual attention</strong>. Whether you're touching your toes for the first time or working toward advanced inversions, our instructors offer real-time modifications so every body in the room is challenged at the right level.
                </p>
                <p className=" mb-4">
                  <strong>Sessions run 60–75 minutes</strong> and include warm-up, a dynamic asana flow, cool-down, and guided meditation. Mats and props are provided for in-person classes. Online participants need only a mat and an open floor space.
                </p>
              ...
              <div className="col-lg-6">
                <div style={{ borderRadius: 16, overflow: "hidden", boxShadow: "0 20px 60px rgba(0,0,0,0.12)" }}>
                  <img
                    src="/img/services/yoga/group-yoga-session.jpg"
