...
export default function OrderConfirmationPage() {
 ...
 <span className="" style={{ fontSize: "13px" }}>Order ID</span>
 ...
 {paymentId && (
 <div className="d-flex justify-content-between mb-2">
 <span className="" style={{ fontSize: "13px" }}>Payment ID</span>
 <span className="fw-semibold" style={{ fontSize: "13px", fontFamily: "monospace" }}>
 {paymentId}
 </span>
 </div>
 ...
 {email && (
 <div className="d-flex justify-content-between mb-2">
 <span className="" style={{ fontSize: "13px" }}>Confirmation sent to</span>
 <span className="fw-semibold" style={{ fontSize: "13px" }}>{email}</span>
 </div>
 )}
 {amount && (
 <div className="d-flex justify-content-between">
 <span className="" style={{ fontSize: "13px" }}>Amount Paid</span>
 ...
 <p className=" mb-5" style={{ fontSize: "13px" }}>
