...
export default function ProductDetailsPage({ product }) {
 ...
 <span className=" text-decoration-line-through mb-2">{regularFormatted}</span>
 )}
 </div>
 ...
 <p className="" style={{ lineHeight: "1.75", fontSize: "15px" }}>{description}</p>
 </div>
 ...
 <ul className=" ps-4" style={{ lineHeight: "1.9", fontSize: "14px" }}>
