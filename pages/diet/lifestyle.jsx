  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta property="og:image" content="/img/services/diet/Lifestyle-Disorder.jpg" />
              ...
              <div className="row g-0 align-items-stretch">
                ...
                <div className="col-lg-5">
                  <div style={{ position: "relative", width: "100%", height: "100%", minHeight: 450, background: "#f8f9fa" }}>
                    <Image 
                      src="/img/services/diet/Lifestyle-Disorder.jpg" 
                      alt="Clinical nutrition for lifestyle disorders" 
                      fill 
