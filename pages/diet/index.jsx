...
const dietServices = [
  {
    ...
    description:
      "Digestive disorders — IBS, GERD, leaky gut, chronic bloating — are almost always rooted in gut dysbiosis and systemic inflammation, not just food sensitivity. Our therapeutic-grade sattvic nutrition protocols correct the gut microbiome at the cellular level, eliminating triggers rather than suppressing symptoms.",
    conditions: [
  ...
  },
  {
    ...
    description:
      "Autoimmune conditions — rheumatoid arthritis, lupus, Hashimoto's, multiple sclerosis — are fundamentally disorders of immune dysregulation, most commonly triggered by gut permeability and systemic inflammation. Our AIP-based sattvic nutrition protocol removes immune triggers and rebuilds mucosal barrier integrity.",
    conditions: [
...
export default function DietMainPage() {
  return (
    <>
      <PageProgress />
      <Head>
        <title>Sattvic Clinical Nutrition Programs - Poshak Tattva</title>
        <meta
          name="description"
          content="Explore Poshak Tattva's therapeutic-grade sattvic diet programs for digestive disorders, hormonal imbalance, lifestyle diseases, weight management, and autoimmune recovery. Clinical nutrition as root-cause medicine."
        />
      </Head>
            ...
            <div className="row align-items-center g-5">
              <div className="col-lg-7">
                ...
                <h1 className="display-3 fw-bold text-white mb-4" style={{ lineHeight: 1.15 }}>
                  Sattvic Clinical<br />
                  <span style={{ color: "#F5C88A" }}>Nutrition</span>
                </h1>
              ...
              <div className="col-lg-5 d-none d-lg-block">
                <div style={{ borderRadius: "20px", overflow: "hidden", boxShadow: "0 30px 60px rgba(0,0,0,0.3)" }}>
                  <Image
                    ...
                    alt="Sattvic Clinical Nutrition at Poshak Tattva"
                    width={500}
                    height={340}
          ...
          <div className="container">
            <div className="row text-center py-5 g-4">
              {[
                ...
                { num: "500+", label: "Patients Recovered" },
              ...
              {dietServices.map((service, idx) => (
                ...
                >
                  <div className={`row g-0 ${idx % 2 === 1 ? "flex-row-reverse" : ""}`}>
                    {/* Accent Panel */}
                    <div
                      className="col-md-3 d-flex flex-column align-items-center justify-content-center py-8 px-4 text-center"
                    ...
                    >
                      ...
                      <h6 className="fw-bold mb-2" style={{ color: service.accent, fontSize: "0.75rem" }}>CONDITIONS TREATED</h6>
                      <ul className="list-unstyled text-muted" style={{ fontSize: "0.75rem" }}>
                        {service.conditions.slice(0, 3).map((c, i) => (
                          <li key={i} className="mb-1">• {c}</li>
                        ))}
                        {service.conditions.length > 3 && (
                          <li className="text-muted" style={{ fontSize: "0.7rem" }}>+{service.conditions.length - 3} more</li>
                        )}
                      </ul>
                    </div>

                    {/* Content */}
                    <div className="col-md-9 p-6 p-md-8">
