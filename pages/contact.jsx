  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (res.ok) {
        setStatus({
          loading: false,
          ok: "Appointment booked successfully! We'll confirm via email or phone.",
          error: null,
        });
        setForm({
          name: "",
              ...
              <div className="col-lg-8">
                <div className="card p-6 shadow-lg rounded-lg">
                  ...
                  <p className="text-muted mb-6">
                    Schedule your wellness session with us. We'll confirm your
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    >
                      ...
                      {status.ok && (
                        <div className="text-success small">{status.ok}</div>
                      )}
                      {status.error && (
                        <div className="text-danger small">{status.error}</div>
                      )}
                    </div>
                  </form>
                </div>
