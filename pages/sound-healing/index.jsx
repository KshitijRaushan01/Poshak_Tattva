    ...
    <>
      ...
      <main className="content-wrapper">
        ...
        <section
          ...
          style={{
            background: "linear-gradient(135deg, #1A1040 0%, #3D2070 60%, #7B3F8C 100%)",
            minHeight: "420px",
            display: "flex",
            alignItems: "center",
            position: "relative",
        ...
        >
          <div
            style={{
              ...
              inset: 0,
              backgroundImage:
                "radial-gradient(circle at 20% 50%, rgba(255,255,255,0.06) 0%, transparent 60%), radial-gradient(circle at 80% 20%, rgba(123,63,140,0.3) 0%, transparent 50%)",
            }}
          />
            ...
            <div className="row align-items-center g-5">
              <div className="col-lg-7">
                ...
                <h1 className="display-3 fw-bold text-white mb-4" style={{ lineHeight: 1.15 }}>
                  Sound Healing &<br />
                  <span style={{ color: "#D4A8F0" }}>Nervous System Reset</span>
                </h1>
        ...
        <section style={{ background: "#f8f9fa", borderBottom: "1px solid #e9ecef" }}>
          <div className="container">
            <div className="row text-center py-5 g-4">
              {[
                { num: "4+", label: "Healing Modalities" },
                        ...
                        {service.benefits.map((b, i) => (
                          <div key={i} className="col-sm-6">
                            <div className="d-flex align-items-start gap-2">
                              ...
                              <span className="text-muted" style={{ fontSize: "0.95rem" }}>{b}</span>
                            </div>
                          </div>
                        ))}
                      </div>
        ...
        <section
          ...
          style={{ background: "linear-gradient(135deg, #1A1040 0%, #5C3D8F 100%)" }}
        >
