...
export default function ClassesPage() {
 ...
 <p className="lead ">Join sessions from your home, anytime, anywhere in India</p>
 </div>
 </div>
 </section>
 ...
 <h2 className="h5 fw-bold mb-4">Select Your City</h2>
 ...
 <td>
 <small className="">{cls.seats} seats</small>
 </td>
 <td>
